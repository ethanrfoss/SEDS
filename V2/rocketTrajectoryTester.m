...
% Halya:
r = .1651;
R = rocket(1,r,r,r,r,r/2,4.5,.3,5.1,.4,.2,.4,.2,.01,2,1,r,9.3461,3.5,1,r,3.38674,4,45,dt);
...
%% Run Simulation:
[t,R,Reco,rocketState,drogueState,mainState,a,Ma,FR,nDrogueDeploy,Ldrogue,Tdrogue,Vldrogue,nMainDeploy,Lmain,Tmain,Vlmain,RopeStart] = rocketTrajectory(R,Reco,H,35.35053,-117.80814,1000,'Laitone-Ackeret',dt);
